 ...
 * O locator do mapeamento de tela deve retornar o primeiro div gerado pelo componente rich:select,
 * aquele div que possui 'class="rf-sel"' ou ainda que possui o mesmo ID informado no arquivo XHTML,
 * porém, o ID não é obrigatório, basta selecionar o primeiro div gerado pelo componente.
 * 
 * @author SERPRO
 *
 */
public class RichSelect extends WebButton {

	/**
	 * Clica no campo do rich:select, provocando a abertura ou o fechamento do menu popup.
	 * 
	 * Se após o click o popup estiver aberto e foi informado algum parâmetro para o localizador, 
	 * então busca o item com label igual ao parâmetro e clica neste campo.
	 *  
	 */
	@Override
	public void click() {
	...
	/**
	 * Procura no componente rich:select um item com o mesmo label informado
	 * e se encontrado envia um evento de click() para o elemento correspondente.
	 * 
	 * @param txtMenuItem
	 */
